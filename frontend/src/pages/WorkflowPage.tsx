    ...
    <div className="flex flex-col gap-6 font-poppins pb-24">
      ...
      <div className="flex justify-between items-end">
        <div className="flex flex-col gap-1">
          <h2 className="text-[28px] font-bold font-oswald text-gray-900 dark:text-gray-100 leading-tight">Workflow (Circuit de validation)</h2>
          ...
          <div className="flex items-center gap-2 text-[11px] font-medium text-gray-400 mt-1">
             <span>Accueil</span> <span>›</span> <span className="text-gray-900 font-semibold dark:text-gray-100">Workflow</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-4">
         <KpiBox icon={GitBranch} color="text-orange-500" bg="bg-orange-100" label="Workflows actifs" value="24" trend="↑ 14.3% ce mois" trendColor="text-green-500" />
         <KpiBox icon={FileText} color="text-yellow-600" bg="bg-yellow-100" label="Docs en validation" value="186" trend="↑ 11.7% ce mois" trendColor="text-green-500" />
         <KpiBox icon={Clock} color="text-purple-500" bg="bg-purple-100" label="Étapes en attente" value="47" trend="↓ -5.2% ce mois" trendColor="text-red-500" />
         <KpiBox icon={CheckCircle} color="text-green-500" bg="bg-green-100" label="Validés aujourd'hui" value="58" trend="↑ 20.8% ce jour" trendColor="text-green-500" />
         <KpiBox icon={XCircle} color="text-red-500" bg="bg-red-100" label="Rejetés aujourd'hui" value="8" trend="↓ -11.1% ce jour" trendColor="text-red-500" />
      ...
      <div className="flex flex-col xl:flex-row gap-5 items-start">
         ...
         <div className="flex-1 flex flex-col gap-6 min-w-0 w-full">
            ...
            {/* Workflows Table */}
            <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-5 shadow-sm overflow-hidden flex flex-col">
               ...
               <div className="flex justify-between items-center mb-4">
                 <div className="relative">
                   ...
                   <input type="text" placeholder="Rechercher un workflow..." className="pl-8 pr-4 py-1.5 border border-gray-200 rounded-lg text-xs w-64 outline-none" />
                 </div>
                 <button className="p-1.5 border border-gray-200 rounded-lg text-gray-500 hover:bg-gray-50"><Filter size={14}/></button>
               </div>
               ...
               <div className="overflow-x-auto custom-scrollbar">
                 <table className="w-full text-left text-xs whitespace-nowrap">
                   ...
                   <tbody className="text-gray-800">
                     <WfRow name="Validation rapport annuel" starred type="Rapport" dep="Statistiques & Analyses" steps={5} resp="Sofiane H." docs={24} stat="Actif" date="15/05/2024" />
                     <WfRow name="Circuit courrier entrant" type="Courrier" dep="Administration" steps={4} resp="Nadia A." docs={186} stat="Actif" date="14/05/2024" />
                     <WfRow name="Demande de financement" type="Demande" dep="Direction Générale" steps={6} resp="Yacine M." docs={32} stat="Brouillon" date="13/05/2024" />
                     <WfRow name="Validation contrat" type="Contrat" dep="Service Juridique" steps={5} resp="Karim B." docs={18} stat="Actif" date="12/05/2024" />
                     <WfRow name="Procédure d'achat" type="Demande" dep="Achats" steps={7} resp="Sofiane H." docs={41} stat="Actif" date="10/05/2024" />
                     <WfRow name="Note de service" type="Note" dep="Bureau Statistiques" steps={3} resp="Nadia A." docs={25} stat="Inactif" date="08/05/2024" />
                   </tbody>
                 </table>
               </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 bg-white border border-gray-200 rounded-2xl p-6 shadow-sm relative">
               ...
               <div className="flex flex-col lg:flex-row gap-6 lg:col-span-1">
                  ...
                  <div className="w-full lg:w-56 flex flex-col gap-3">
                     ...
                     <div className="flex flex-col items-center gap-2 relative">
                        ...
                        <ArrowDown />
                        <WfNode title="Diffusion" sub="Tous les membres" user="Bureau Statistiques" delay="0 jour" color="bg-gray-50" border="border-gray-200" zIndex="z-10" />
                     </div>
                  </div>
                  ...
                  <div className="flex-1 flex flex-col gap-4">
                     ...
                     <form className="flex flex-col gap-3 bg-gray-50 p-4 rounded-xl border border-gray-100">
                        ...
                        <div className="flex flex-col gap-1.5">
                           ...
                           <div className="flex items-center gap-2 border border-gray-200 bg-white rounded-lg p-1.5 px-3">
                              <img src="https://ui-avatars.com/api/?name=Sofiane+H" className="w-5 h-5 rounded-full" />
                              <span className="text-xs font-semibold text-gray-800 flex-1">Sofiane Hamidi</span>
                        ...
                        <div className="flex gap-3 mt-2">
                           <button className="flex-1 py-1.5 border border-gray-200 bg-white rounded-lg text-[10px] font-semibold text-gray-600 flex justify-center items-center gap-1 shadow-sm"><Copy size={12}/> Dupliquer étape</button>
               ...
               <div className="flex flex-col gap-6 lg:col-span-1">
                  ...
                  <div className="flex flex-col gap-4">
                     ...
                     <div className="flex flex-col gap-4 bg-gray-50 border border-gray-100 p-4 rounded-xl">
                        {/* Progress Stepper */}
                     ...
                     <div className="flex flex-col gap-2">
                        <span className="text-[11px] font-semibold text-gray-800">Commentaires</span>
                        <div className="bg-green-50 border border-green-100 p-3 rounded-xl flex gap-3 text-xs">
                           ...
                           <div className="flex flex-col gap-1 text-[11px]">
                              <strong className="text-gray-800">Nadia A. - Chef de service</strong>
                              <span className="text-gray-500">15/05/2024 à 11:15</span>
                              <p className="text-gray-700 mt-1">Le rapport est complet, je valide cette étape.</p>
                           </div>
                        </div>
                        <div className="bg-gray-50 border border-gray-100 p-3 rounded-xl flex gap-3 text-xs">
                           <img src="https://ui-avatars.com/api/?name=Yacine+M" className="w-6 h-6 rounded-full" />
                           <div className="flex flex-col gap-1 text-[11px]">
                              <strong className="text-gray-800">Yacine M. - Initiateur</strong>
                              <span className="text-gray-500">15/05/2024 à 10:10</span>
                              <p className="text-gray-700 mt-1">Document créé et envoyé pour validation.</p>
                           </div>
                        </div>
                     </div>
                     <button className="w-full py-2 border border-gray-200 bg-white rounded-lg text-xs font-semibold text-gray-600 hover:bg-gray-50">Voir le document</button>
                  </div>
               </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
               ...
               <div className="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm">
                  ...
                  <div className="flex items-end gap-6 h-32 pl-4 border-l border-b border-gray-200 pb-2 relative text-[9px] text-gray-400">
                     {/* fake bar chart */}
         ...
         <div className="w-full xl:w-[320px] shrink-0 flex flex-col gap-6">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm flex flex-col gap-4">
               ...
               <div className="bg-orange-50/50 rounded-xl p-4 flex justify-center h-32 relative">
                  ...
                  <div className="flex gap-4 items-center">
                     <div className="w-10 h-10 border-2 border-dashed border-orange-300 rounded-xl bg-white relative z-10 flex items-center justify-center">
                       <img src="https://ui-avatars.com/api/?name=Y" className="w-6 h-6 rounded-full" />
                     </div>
                     <div className="h-0.5 w-8 bg-orange-300"></div>
                     <div className="w-12 h-12 border-2 border-orange-400 rounded-xl bg-white relative z-10 flex items-center justify-center shadow-md">
                       <CheckCircle className="text-green-500" size={24} />
                     </div>
                     <div className="h-0.5 w-8 bg-gray-300"></div>
                     <div className="w-10 h-10 border-2 border-dashed border-gray-300 rounded-xl bg-white relative z-10 flex items-center justify-center">
               ...
               <button className="w-full py-2 border border-gray-200 rounded-lg text-xs font-semibold text-gray-600 hover:bg-gray-50 flex justify-center items-center gap-1.5"><Eye size={14}/> Voir le détail complet</button>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm">
               ...
               <div className="flex flex-col gap-3">
                  ...
                  <UsedDoc icon={<XCircle size={12}/>} bg="bg-gray-500" name="Rapport_Previsions_2024.pdf" stat="En attente" statColor="text-gray-500" />
               </div>
      ...
      <div className="fixed bottom-0 left-0 lg:left-[250px] right-0 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 p-4 px-6 flex justify-between items-center z-50">
         <button className="px-6 py-2 bg-white border border-gray-200 text-gray-700 font-semibold text-[13px] rounded-xl hover:bg-gray-50">Annuler</button>
         ...
         <div className="flex items-center gap-2">
            ...
            <button className="flex items-center gap-1.5 px-4 py-2 border border-gray-200 bg-white text-gray-700 font-semibold text-[12px] rounded-xl hover:bg-gray-50"><Copy size={14}/> Dupliquer</button>
            ...
            <button className="flex items-center gap-1.5 px-4 py-2 border border-gray-200 bg-white text-gray-700 font-semibold text-[12px] rounded-xl hover:bg-gray-50"><Download size={14}/> Exporter</button>
...
function WfRow({ name, starred, type, dep, steps, resp, docs, stat, date }: any) {
  return (
    <tr className="border-b border-gray-50 hover:bg-gray-50 cursor-pointer text-[11px] font-medium transition-colors">
       ...
       <td className="py-2.5 px-2 text-gray-600">{type}</td>
       <td className="py-2.5 px-2 text-gray-600">{dep}</td>
       ...
       <td className="py-2.5 px-2 text-center text-gray-800">{docs}</td>
       <td className="py-2.5 px-2 text-center">
         <span className={`px-2 py-0.5 rounded flex items-center justify-center w-max mx-auto border font-bold
           ${stat==='Actif'?'bg-green-50 text-green-600 border-green-200':
             ...
             'bg-gray-100 text-gray-500 border-gray-200'}`}>{stat}</span>
       </td>
       <td className="py-2.5 px-2 text-gray-500">{date}</td>
       <td className="py-2.5 px-2">
         <div className="flex items-center justify-center gap-2 text-gray-400">
           <Eye size={12} className="hover:text-gray-700" />
           <Edit2 size={12} className="hover:text-gray-700" />
           <Copy size={12} className="hover:text-gray-700" />
           <MoreVertical size={12} className="hover:text-gray-700" />
         </div>
       </td>
    </tr>
  );
  ...
  return (
    <div className={`w-48 p-2.5 rounded-xl border-2 ${border} ${color} flex gap-2 relative ${shadow} ${zIndex} transition-transform ${active ? 'scale-105' : ''}`}>
       ...
       <div className="flex flex-col text-left">
          <strong className="text-[10px] font-bold text-gray-800 leading-tight">{title}</strong>
          <span className="text-[9px] font-medium text-gray-700">{user}</span>
...
function Field({ label, val, isSelect }: any) {
  return (
    <div className="flex flex-col gap-1.5">
       ...
       {isSelect ? (
         <select className="border border-gray-200 bg-white rounded-lg p-2 text-xs font-semibold text-gray-800 outline-none" defaultValue={val}>
           <option value={val}>{val}</option>
         </select>
       ) : (
         <input type="text" className="border border-gray-200 bg-white rounded-lg p-2 text-xs font-semibold text-gray-800 outline-none" defaultValue={val} />
       )}
    </div>
  );
}
...
function ProgressStep({ status, icon: Icon, label, sub, user }: any) {
  ...
  const color = isDone ? 'text-green-500 border-green-500 bg-green-50' : isActive ? 'text-orange-500 border-orange-500 bg-orange-50' : 'text-gray-400 border-gray-300 bg-white';
  ...
  return (
    <div className="flex flex-col items-center gap-1 z-10 w-16 text-center">
      ...
      <strong className={`text-[8px] leading-tight font-bold mt-1 ${isActive ? 'text-gray-900' : 'text-gray-600'}`}>{label}</strong>
  ...
  return (
    <div className="flex justify-between items-center text-[10px] font-medium">
      ...
      <div className="flex gap-4 w-20 justify-between items-center">
         <strong className={`text-xs ${alert ? 'text-red-600' : 'text-gray-800'}`}>{count}</strong>
...
function MetaRow({ label, val }: any) {
  return (
    <div className="flex justify-between pb-1.5 border-b border-gray-100 last:border-0">
      <span className="text-gray-500">{label}</span>
      <span className="font-semibold text-gray-800 text-right max-w-[140px] truncate">{val}</span>
    </div>
  );
}
