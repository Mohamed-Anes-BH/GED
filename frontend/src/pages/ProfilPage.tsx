...
export function ProfilPage() {
  return (
    <div className="flex flex-col gap-6 font-poppins pb-10 text-gray-800">
      ...
      <h2 className="text-3xl font-bold font-oswald text-gray-900 flex items-center gap-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Profile Card */}
        <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 flex flex-col items-center text-center gap-4">
          <div className="relative">
            <img src="https://ui-avatars.com/api/?name=Sofiane+Hamidi&size=120&background=random" className="w-28 h-28 rounded-full border-4 border-white shadow-md" alt="Avatar"/>
            <button className="absolute bottom-0 right-0 w-8 h-8 bg-yellow-400 text-gray-900 rounded-full flex items-center justify-center shadow hover:bg-yellow-500 transition-colors">
              <Camera size={14}/>
            </button>
          </div>
          <div>
            <h3 className="text-xl font-bold font-oswald">Sofiane Hamidi</h3>
            <span className="text-[11px] font-bold text-yellow-500 uppercase tracking-wider">Administrateur GED</span>
          </div>
          <div className="flex flex-col gap-2.5 w-full text-left text-[12px] mt-2">
            <div className="flex items-center gap-3"><Monitor size={14} className="text-gray-400"/><span className="text-gray-600">Direction Informatique</span></div>
            <div className="flex items-center gap-3"><UserCircle size={14} className="text-gray-400"/><span className="text-gray-600">Développement Web</span></div>
            <div className="flex items-center gap-3"><Mail size={14} className="text-gray-400"/><span className="text-blue-500 font-medium">sofiane.hamidi@agrodiv.dz</span></div>
            <div className="flex items-center gap-3"><Phone size={14} className="text-gray-400"/><span className="text-gray-600">+213 555 12 34 56</span></div>
          </div>
          ...
          <button className="w-full py-2.5 border border-gray-200 rounded-xl text-xs font-semibold hover:bg-gray-50 flex items-center justify-center gap-2">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 flex flex-col">
          ...
          <div className="grid grid-cols-2 gap-4 flex-1">
            <div className="flex flex-col gap-1.5">
              ...
              <input value="Hamidi" readOnly className="border border-gray-200 rounded-lg px-3 py-2 text-xs font-medium text-gray-700 bg-gray-50"/>
            </div>
            <div className="flex flex-col gap-1.5">
              <label className="text-[11px] font-bold text-gray-600">Prénom <span className="text-red-500">*</span></label>
              <input value="Sofiane" readOnly className="border border-gray-200 rounded-lg px-3 py-2 text-xs font-medium text-gray-700 bg-gray-50"/>
            </div>
            <div className="flex flex-col gap-1.5 text-blue-500">
              ...
              <input value="sofiane.hamidi@agrodiv.dz" readOnly className="border border-gray-200 rounded-lg px-3 py-2 text-xs font-medium text-blue-500 bg-blue-50/30"/>
            </div>
            <div className="flex flex-col gap-1.5">
              <label className="text-[11px] font-bold text-gray-600">Téléphone <span className="text-red-500">*</span></label>
              <input value="+213 555 12 34 56" readOnly className="border border-gray-200 rounded-lg px-3 py-2 text-xs font-medium text-gray-700 bg-gray-50"/>
            </div>
            <div className="flex flex-col gap-1.5 col-span-2">
              <label className="text-[11px] font-bold text-gray-600">Date de naissance</label>
              <div className="relative">
                <Calendar size={14} className="absolute left-3 top-2.5 text-gray-400"/>
                <input value="15 / 05 / 1998" readOnly className="border border-gray-200 rounded-lg pl-9 pr-3 py-2 text-xs font-medium text-gray-700 bg-white w-full"/>
              </div>
            </div>
            <div className="flex flex-col gap-1.5 col-span-2">
              <label className="text-[11px] font-bold text-gray-600">Adresse</label>
              <input value="Cité 500 Logements, Bâtiment 7, N°12" readOnly className="border border-gray-200 rounded-lg px-3 py-2 text-xs font-medium text-gray-700 bg-white w-full"/>
            </div>
            <div className="flex flex-col gap-1.5">
              <label className="text-[11px] font-bold text-gray-600">Pays</label>
              <select className="border border-gray-200 rounded-lg px-3 py-2 text-xs font-medium text-gray-700 bg-white outline-none"><option>Algérie</option></select>
            </div>
            <div className="flex flex-col gap-1.5">
              <label className="text-[11px] font-bold text-gray-600">Ville</label>
              <input value="Sétif" readOnly className="border border-gray-200 rounded-lg px-3 py-2 text-xs font-medium text-gray-700 bg-white w-full"/>
            </div>
          </div>
          <div className="flex gap-2 mt-5">
            <button className="flex-1 bg-yellow-400 text-gray-900 rounded-xl py-2.5 font-bold text-xs shadow-sm hover:bg-yellow-500 flex justify-center items-center gap-2"><Lock size={14}/> Enregistrer</button>
            <button className="flex-1 border border-gray-200 text-gray-600 rounded-xl py-2.5 font-semibold text-xs hover:bg-gray-50 flex justify-center items-center">Annuler</button>
          </div>
        </div>

        {/* Infos Pro + Illustration */}
        <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 flex flex-col relative overflow-hidden">
          ...
          <div className="flex flex-col gap-4 text-[12px] z-10 w-2/3">
            {[
              ...
              <div key={l} className="flex"><span className="text-gray-500 w-32 shrink-0">{l}</span><span className="font-semibold text-gray-800">{v}</span></div>
            ))}
          ...
          <div className="absolute -bottom-4 right-0 w-48 h-48 opacity-90 pointer-events-none flex flex-col items-end justify-end p-4">
             ...
             <div className="w-32 h-32 bg-yellow-100 rounded-tl-full relative">
                <div className="absolute top-4 right-8 w-16 h-20 bg-white shadow-sm border border-gray-100 rounded-md"></div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        {/* Security list */}
        <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 md:col-span-1">
          ...
          <div className="flex flex-col gap-3 text-[11px]">
            ...
            <div className="flex justify-between"><div className="flex items-center gap-2 text-gray-500"><Lock size={13}/> Mot de passe</div> <span className="font-medium text-gray-700">*************</span></div>
            <div className="flex justify-between"><div className="flex items-center gap-2 text-gray-500"><Calendar size={13}/> Dernière connexion</div> <span className="font-medium text-gray-700">Aujourd'hui à 08:42</span></div>
            ...
            <div className="flex justify-between"><div className="flex items-center gap-2 text-gray-500"><Globe size={13}/> Navigateur</div> <span className="font-medium text-gray-700">Google Chrome 125.0</span></div>
            <div className="flex justify-between"><div className="flex items-center gap-2 text-gray-500"><Monitor size={13}/> Système</div> <span className="font-medium text-gray-700">Windows 11</span></div>
          </div>
          <button className="w-full mt-6 py-2.5 bg-yellow-400 text-gray-900 rounded-xl font-bold text-xs shadow-sm hover:bg-yellow-500 flex justify-center items-center gap-2">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 md:col-span-1">
          ...
          <div className="flex flex-col gap-5 text-[12px] font-semibold text-gray-600">
            ...
            <div className="flex justify-between items-center text-gray-800 mt-2">
              ...
              <select className="border border-gray-200 bg-gray-50 rounded-lg px-2 py-1 text-[11px] outline-none"><option>Français</option></select>
            </div>
          </div>
        </div>

        {/* Active sessions */}
        <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 md:col-span-2 flex flex-col">
          ...
          <div className="overflow-x-auto flex-1">
            <table className="w-full text-left text-[11px]">
              ...
              <tbody>
                <tr className="border-b border-gray-50 text-gray-800 font-medium">
        ...
        <div className="flex gap-4 w-full relative z-10 px-8 py-2">
          ...
          {[
            ...
            <div key={i} className="flex flex-col items-center flex-1 gap-3 relative">
              <div className={`w-12 h-12 rounded-full border-2 ${item.c} flex items-center justify-center bg-white z-10`}>
                <item.icon size={20}/>
              </div>
              <div className="flex flex-col items-center text-center">
                <span className="font-bold text-[12px] text-gray-800">{item.a}</span>
                <span className="text-[10px] text-gray-500">{item.d}</span>
                <span className="text-[10px] font-medium text-gray-600 mt-1">{item.s}</span>
              </div>
            </div>
          ))}
        </div>
        
        <div className="flex gap-4 mt-10 w-full justify-center pb-6 border-b border-gray-100">
           <button className="px-10 py-3 bg-yellow-400 text-gray-900 rounded-xl font-bold text-sm shadow-sm hover:bg-yellow-500 flex justify-center items-center gap-2"><Lock size={15}/> Enregistrer</button>
