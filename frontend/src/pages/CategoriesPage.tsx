import { BoxSelect, Search, Plus, Edit2, Trash2 } from 'lucide-react';

export function CategoriesPage() {
  const items = [
    { code: 'CAT-001', nom: 'Rapports Financiers', type: 'Finances', docs: 890 },
    { code: 'CAT-002', nom: 'Contrats Fournisseurs', type: 'Juridique', docs: 450 },
    { code: 'CAT-003', nom: 'Dossiers Employés', type: 'RH', docs: 3200 },
  ];
  ...
  return (
    <div className="flex flex-col gap-6 font-poppins pb-10 text-gray-800 h-[calc(100vh-140px)]">
      <div className="flex items-start gap-4">
        ...
        <div>
          <h2 className="text-3xl font-bold font-oswald text-gray-900">Catégories</h2>
      ...
      <div className="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden flex flex-col flex-1">
        ...
        <table className="w-full text-left text-[12px] whitespace-nowrap">
          <thead><tr className="bg-gray-50 border-b border-gray-100 text-gray-500 font-bold"><th className="py-3 px-5">Code</th><th className="py-3 px-5">Nom</th><th className="py-3 px-5">Type de document</th><th className="py-3 px-5">Documents</th><th className="py-3 px-5 text-right">Actions</th></tr></thead>
